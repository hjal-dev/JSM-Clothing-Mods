...
namespace JSM.JunkoPurity;

public record ModMetadata : AbstractModMetadata
{
    public override string ModGuid { get; init; } = "com.jsm.junkopurity";
    public override string Name { get; init; } = "JSM - Junko Purity [TOUHOU]";
...
public class JunkoPurityMod(WTTServerCommonLib.WTTServerCommonLib wtt) : IOnLoad
{
