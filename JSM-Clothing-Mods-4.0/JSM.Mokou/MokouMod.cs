...
{
    public override string ModGuid { get; init; } = "com.jsm.mokou";
    public override string Name { get; init; } = "JSM - Mokou [TOUHOU]";
...
public class MokouMod(WTTServerCommonLib.WTTServerCommonLib wtt) : IOnLoad
{
